...
# 创建按钮
qt_button = tk.Button(app, text="启动 QT GUI (功能更完善)", width=30, command=run_qt_gui)
qt_button.pack(pady=5)

webui_button = tk.Button(app, text="启动 WebUI (适配更及时)", width=30, command=run_webui)
webui_button.pack(pady=5)

cli_button = tk.Button(app, text="启动命令行 (性能最好)", width=30, command=run_command_line)
