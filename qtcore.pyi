...
class QModelRoleDataSpan(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, modelRoleData: typing.Iterable[QModelRoleData]) -> None: ...
    @typing.overload
...
class QCborStreamReader(PyQt6.sip.simplewrapper):
    ...
    def readUtf8String(self) -> typing.Tuple[QByteArray, 'QCborStreamReader.StringResultCode']: ...
...
class QLocale(PyQt6.sip.simplewrapper):
    ...
    def uiLanguages(self, separator: 'QLocale.TagSeparator' = ...) -> typing.List[str]: ...
    @typing.overload
